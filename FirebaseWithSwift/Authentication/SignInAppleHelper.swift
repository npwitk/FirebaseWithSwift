...
//  FirebaseWithSwift
//
//  Created by Nonprawich I. on 24/3/25.
//
...
struct SignInWithAppleButtonViewRepresentable: UIViewRepresentable { // Convert UIKit to SwiftUI
...
final class SignInAppleHelper: NSObject {
    ...
    // New way with Swift concurrency
